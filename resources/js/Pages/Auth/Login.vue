...
const pageTranslations = (name = "", attributes = {}) => {
    return trans(`pages.auth.login.${name}`, attributes);
};
</script>
        ...
        <AuthenticationCard>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mt-4">
                    <InputLabel
                        for="password"
                        :value="ucfirst($t('validation.attributes.password'))"
                    />
                    <TextInput
                        id="password"
                ...
                <div class="block mt-4">
                    <label class="flex items-center">
                        ...
                        <span
                            ...
                            >{{ pageTranslations("remember-me") }}</span
                        >
                    </label>
                </div>
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    >
                        {{ pageTranslations("forgot-password") }}
                    </Link>
            ...
            <template #out>
                <p
                    class="flex gap-x-1 items-center text-black dark:text-white mt-2"
                >
                    {{ pageTranslations("have-no-account") }}
                    <Link
                        :href="route('register')"
