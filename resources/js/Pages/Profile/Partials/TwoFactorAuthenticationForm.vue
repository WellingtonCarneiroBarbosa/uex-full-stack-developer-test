...
const pageTranslations = (name = "", attributes = {}) => {
    return trans(`pages.profile.two-f-auth.${name}`, attributes);
};
...
<template>
    <ActionSection>
        ...
        <template #content>
            ...
            >
                {{ pageTranslations("enabled-title") }}
            </h3>
            ...
            <h3
                ...
                class="text-lg font-medium text-gray-900 dark:text-gray-100"
            >
                {{ pageTranslations("not-enabled-title") }}
            </h3>

            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                <p>
                    {{ pageTranslations("not-enabled-disclaimer") }}
                </p>
            </div>
                ...
                <div v-if="qrCode">
                    ...
                    >
                        <p v-if="confirming" class="font-semibold">
                            {{ pageTranslations("finish-disclaimer") }}
                        </p>

                        <p v-else>
                            {{ pageTranslations("enabled-disclaimer") }}
                        </p>
                    </div>
                    ...
                    <div v-if="confirming" class="mt-4">
                        <InputLabel
                            for="code"
                            :value="ucwords($t('validation.attributes.code'))"
                        />
                ...
                <div v-else>
                    ...
                    <ConfirmsPassword @confirmed="showRecoveryCodes">
                        <SecondaryButton
                            ...
                            class="me-3"
                        >
                            {{ pageTranslations("show-recovery-codes") }}
                        </SecondaryButton>
                    </ConfirmsPassword>
